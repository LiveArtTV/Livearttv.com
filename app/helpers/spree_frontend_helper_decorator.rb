Spree::FrontendHelper.module_eval do
  def breadcrumbs(model, separator="&nbsp;")
    ...
    if model.is_a?(Spree::Taxon)
      ...
      crumbs << content_tag(:li, content_tag(:span, link_to_if(!model.try(:count), content_tag(:span, Spree.t(:artists), itemprop: "name"), authors_path, itemprop: "url") + separator, itemprop: "item"), itemscope: "itemscope", itemtype: "https://schema.org/ListItem", itemprop: "itemListElement")
      ...
      crumbs << content_tag(:li, content_tag(:span, link_to_if(!model.try(:count), content_tag(:span, Spree.t(:library), itemprop: "name"), videos_path, itemprop: "url") + separator, itemprop: "item"), itemscope: "itemscope", itemtype: "https://schema.org/ListItem", itemprop: "itemListElement")
