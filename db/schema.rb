...
ActiveRecord::Schema.define(version: 20171013143903) do
  ...
  create_table "spree_authors", force: :cascade do |t|
    ...
    t.datetime "created_at",                               null: false
    t.datetime "updated_at",                               null: false
    t.index ["category"], name: "index_spree_authors_on_category", using: :btree
    t.index ["slug"], name: "index_spree_authors_on_slug", using: :btree
  end
  ...
  create_table "spree_products", force: :cascade do |t|
    ...
    t.index ["author_id"], name: "index_spree_products_on_author_id", using: :btree
  ...
  create_table "spree_taxons", force: :cascade do |t|
    ...
    t.index ["show_on_home"], name: "index_spree_taxons_on_show_on_home", using: :btree
